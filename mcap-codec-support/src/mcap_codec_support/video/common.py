...
# A 32x32 baseline JPEG kept for lightweight probes and test fixtures.
...
# A 256x256 baseline JPEG for hardware decoders that reject tiny probe frames.
HW_PROBE_JPEG: bytes = base64.b64decode(
