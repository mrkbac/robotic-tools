...
def test_nested_message_with_memoryview_array() -> None:
    ...
    # to_plain should recurse and produce a real list for the inner field.
    class _Imu:
        __slots__ = ("cov", "temp")
...
def test_time_slots_object_collapses_to_int_nanoseconds() -> None:
    ...
    assert to_plain(_Time(1, 500_000_000)) == 1_500_000_000
    assert to_plain(_Time(0, 0)) == 0
...
def test_time_dict_collapses_to_int_nanoseconds() -> None:
    ...
    assert to_plain({"sec": 2, "nanosec": 750_000_000}) == 2_750_000_000
