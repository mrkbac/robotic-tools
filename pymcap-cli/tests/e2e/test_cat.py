...
class TestCat:
    ...
    def test_cat_text_output(self, simple_mcap: Path):
        ...
        result = subprocess.run(
            ["pymcap-cli", "cat", str(simple_mcap), "--limit", "1"],
            capture_output=True,
            text=True,
            check=False,
        )
    ...
    def test_cat_json_output(self, image_small_mcap: Path):
        ...
        result = subprocess.run(
            ["pymcap-cli", "cat", str(image_small_mcap), "--limit", "1", "--json"],
            capture_output=True,
            text=True,
            check=False,
        )
    ...
    def test_cat_topic_filter(self, multi_topic_mcap: Path):
        ...
        result = subprocess.run(
            ["pymcap-cli", "cat", str(multi_topic_mcap), "--topics", "/camera/.*", "--limit", "5"],
            capture_output=True,
            text=True,
            check=False,
        )
    ...
    def test_cat_limit(self, multi_topic_mcap: Path):
        """Test message limit."""
        result = subprocess.run(
            ["pymcap-cli", "cat", str(multi_topic_mcap), "--limit", "3"],
            capture_output=True,
            text=True,
            check=False,
        )
    ...
    def test_cat_image_compressed(self, image_compressed_mcap: Path):
        ...
        result = subprocess.run(
            ["pymcap-cli", "cat", str(image_compressed_mcap), "--limit", "1", "--json"],
            capture_output=True,
            text=True,
            check=False,
        )
    ...
    def test_cat_no_limit(self, simple_mcap: Path):
        ...
        result = subprocess.run(
            ["pymcap-cli", "cat", str(simple_mcap)],
            capture_output=True,
            text=True,
            check=False,
        )
    ...
    def test_cat_nonexistent_file(self):
        ...
        result = subprocess.run(
            ["pymcap-cli", "cat", "nonexistent.mcap"],
            capture_output=True,
            text=True,
            check=False,
        )
